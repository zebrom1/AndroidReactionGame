...
public class StableArrayAdapter extends ArrayAdapter<ScoreLayout>
{
    List<ScoreLayout> values;

    public StableArrayAdapter(Context context, int textViewResourceId,
                              List<ScoreLayout> objects)
    {
    ...
    public View getView(int position, View cvtView, ViewGroup parent)
    {
        ...
        View rowView = inflater.inflate(R.layout.fragment_scores, parent, false);
